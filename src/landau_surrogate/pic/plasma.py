...
from landau_surrogate.pic.particles import particles
from landau_surrogate.pic.functions import (max_vect, numba_interp1D_normed, numba_return_part_diag)
from landau_surrogate.pic.constantes import (me, q, eps_0, mi)
from landau_surrogate.pic.poisson_solver import Poisson_Solver
import h5py
...
class plasma:
    ...
    def validated(self):
        from landau_surrogate.pic.gui import GUI
